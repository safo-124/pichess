// Home is handled by app/(main)/page.tsx via the (main) route group.
// Next.js gives precedence to the route group page for "/".
// This file intentionally re-exports it to avoid a missing-page error.
