            ...
            <div key={lesson.title + i}>
              <button
                ...
                className={`w-full text-left rounded-2xl border transition-all duration-300 overflow-hidden backdrop-blur-sm group ${
                  isOpen
                    ? "border-[#c9a84c]/25 bg-white shadow-lg shadow-[#c9a84c]/5"
              ...
              >
                ...
                <div className="relative px-6 py-5 flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4 min-w-0">
                    <span className="shrink-0 w-8 h-8 rounded-lg bg-gray-100 border border-gray-200 flex items-center justify-center text-xs font-black text-[#c9a84c]">
                      {i + 1}
                    </span>
                    <span className="text-2xl shrink-0 group-hover:scale-110 transition-transform duration-300">
                      {lesson.icon}
                    </span>
                    <span className="text-base font-bold text-gray-900 truncate group-hover:text-[#c9a84c] transition-colors">
                      {lesson.title}
                    </span>
                  </div>
                  ...
                  <motion.span
                    ...
                    className="shrink-0 text-gray-400 text-lg"
                  >
                    ▾
                  </motion.span>
                </div>
                  ...
                  >
                    <div className="px-6 pb-6 pt-2 ml-12">
                      ...
                      <Link
                        ...
                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-[#c9a84c] to-[#dbb95d] text-white text-sm font-bold hover:from-[#dbb95d] hover:to-[#c9a84c] transition-all hover:shadow-lg hover:shadow-[#c9a84c]/20"
                      >
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {institutional.map((lesson, i) => (
              <div
                key={lesson.title}
                className="relative group rounded-2xl border border-gray-200 bg-white backdrop-blur-sm p-6 transition-all duration-500 hover:border-blue-300 hover:shadow-lg hover:shadow-blue-500/5 overflow-hidden"
              >
                {/* Gradient accent */}
                ...
                <div className="relative z-10">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-gray-400 text-sm leading-relaxed mt-1">{lesson.desc}</p>
                    </div>
                  </div>
                  <Link
                    href={`/academy/enquire?program=${encodeURIComponent(lesson.title)}`}
                    className="inline-flex items-center gap-2 mt-4 px-5 py-2 rounded-full border border-blue-300 text-blue-600 text-xs font-bold hover:bg-blue-50 transition-all"
                  >
